...
document_conversion = DocumentConversionV1(
    username='ddf87688-7199-4f4d-906c-1fca8ea6ef3b',
    password='zvyVBcuc3iWd',
    version='2016-02-09')
...
with open(join(dirname(__file__), 'resources/example.html'), 'r') as document:
    ...
    print(document_conversion.convert_document(document=document, config=config, media_type='text/html').content)
